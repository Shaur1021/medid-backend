...
def ask():
    try:
        ...
        if "cough" in symptoms and "fever" in symptoms:
        ...
        elif "yellow skin" in symptoms or "jaundice" in symptoms:
            ...
            emergency_advice = "Call 911 or emergency services immediately."
        elif "double vision" in symptoms:
        ...
        elif "blood in urine" in symptoms:
        ...
        elif "severe thirst" in symptoms:
